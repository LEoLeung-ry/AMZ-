...
class LiveRuleRefinementTests(unittest.TestCase):
    def test_refined_live_categories_are_flagged(self) -> None:
        categories = [
            ...
            ("多组分蛋白质", "Mehrkomponenten Proteine", "health", "C"),
            ("肌酸", "Kreatin", "health", "C"),
            ("薯片和薯片", "Chips & Crisps", "grocery", "C"),
            ("猫用软质零食", "猫用ソフトスナック", "pet-supplies", "C"),
            ("谷物饲料", "Körnerfutter", "pet-supplies", "C"),
            ("保湿眼药水", "Moisturizing Eye Drops", "health", "C"),
            ("止痒药", "Itch Remedies", "health", "C"),
            ("男士自慰用品", "アダルト用ホール（カップ）", "adult", "D"),
            ...
            ("控制台", "Game Consoles", "video-games", "B"),
            ("控制器", "Gaming Controllers", "video-games", "B"),
